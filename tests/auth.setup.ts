...
setup('authenticate', async ({ page }) => {
  ...
  await page.locator('xpath=//a[@id="idA_PWD_SwitchToCredPicker"]').click();
  await page.locator('xpath=//div[@aria-label="Use my password"]').click();
  await page.locator('xpath=//input[@type="password"]').fill('Messi_Pulga_Goat+_10');
  await page.locator('xpath=//input[@type="submit"]').click();
  await page.locator('xpath=//input[@type="submit"]').click();
  ...
  await expect(page.locator('xpath=//span[@id="NavBarDashboard_label"]')).toBeVisible({timeout:10000});
